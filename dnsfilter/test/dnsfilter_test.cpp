    ...
    const test_data TEST_DATA[] =
        {
            ...
            { "@@123.123.123.123", { { .props = { 1 << ag::dnsfilter::RP_EXCEPTION } }, rule_utils::rule::MMID_SUBDOMAINS } },
            { "@@12:34:56:78::90", { { .props = { 1 << ag::dnsfilter::RP_EXCEPTION } }, rule_utils::rule::MMID_SHORTCUTS } },
            { "0.0.0.0", { {}, rule_utils::rule::MMID_SUBDOMAINS } },
            ...
            { "||123.123.123.123^", { {}, rule_utils::rule::MMID_SUBDOMAINS } },
            { "||12:34:56:78::90^", { {}, rule_utils::rule::MMID_SHORTCUTS } },
            { "http://123.123.123.123", { {}, rule_utils::rule::MMID_SUBDOMAINS } },
            { "http://12:34:56:78::90^", { {}, rule_utils::rule::MMID_SHORTCUTS } },
            { "https://123.123.123.123", { {}, rule_utils::rule::MMID_SUBDOMAINS } },
            { "https://12:34:56:78::90^", { {}, rule_utils::rule::MMID_SHORTCUTS } },
...
//            { { "http://example111.org" }, "example111.org1", true, }, // FIXME: line end not asserted, must match
