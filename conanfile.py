...
class DnsLibsConan(ConanFile):
    ...
    def requirements(self):
        self.requires("libcurl/7.88.1-adguard@AdguardTeam/NativeLibsCommon")
        ...
        self.requires("native_libs_common/2.0.51@AdguardTeam/NativeLibsCommon")
        self.requires("ngtcp2/0.13.1@AdguardTeam/NativeLibsCommon")
