...
#define FQN_DNSTUNLISTENER_REPLY_HANDLER FQN_DNSTUNLISTENER "$ReplyHandler"
#define FQN_DNSTUNLISTENER_NATIVE_REPLY_HANDLER FQN_DNSTUNLISTENER "$NativeReplyHandler"
