...
struct ErrorCodeToString<dns::TunListener::InitError> {
    std::string operator()(dns::TunListener::InitError e) {
        switch (e) {
        case dns::TunListener::IE_INVALID_FD:
            return "Invalid file descriptor";
        case dns::TunListener::IE_INVALID_MTU:
            return "Invalid MTU";
        case dns::TunListener::IE_INVALID_CALLBACK:
            return "Callback is null";
        case dns::TunListener::IE_TCPIP_INIT_FAILED:
            return "Failed to initialize tcpip stack";
        default:
